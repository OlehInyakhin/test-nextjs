        ...
        <div className="grid grid-cols-2 md:grid-cols-5 xl:grid-cols-[300px_1fr_1fr_1fr_400px] gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link className="hover:underline" href="/terms-services">
                  Terms & Services
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link className="hover:underline" href="/techlabz-keybox">
                  Techlabz Keybox
                </Link>
              </li>
              <li>
                <Link className="hover:underline" href="/downloads">
                  Downloads
                </Link>
              </li>
              <li>
          ...
          <div className="bg-white/5 p-6 rounded-lg lg:place-self-center max-xl:col-span-full">
            ...
            <div className="flex mb-2">
              ...
              />
              <Button
                className="transition-colors bg-black text-white border-0 hover:text-black hover:bg-white rounded-s-none"
                size="lg"
                variant="outline"
              >
                Subscribe
